...
struct Application * Application_create(
    ...
    */
    ...
    sprintf(application->type_name, "my_type");
    ...
    sprintf(application->topic_name, MY_TOPIC_NAME);
...
DDS_ReturnCode_t Application_enable(struct Application * application) {
    DDS_Entity *entity;
    DDS_ReturnCode_t retcode;
...
void Application_delete(struct Application *application) {
    DDS_ReturnCode_t retcode;
    RT_Registry_T *registry = NULL;
    struct UDP_InterfaceFactoryProperty *udp_property = NULL;
